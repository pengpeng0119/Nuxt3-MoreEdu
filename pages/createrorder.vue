...
<script setup>
import { NCard, NTag, NImage, NIcon, NButton, NGrid, NGridItem } from 'naive-ui'
...
.createorder .wxpay {
  @apply flex items-center justify-center border border-green-500 rounded py-3 text-sm text-green-600 w-[120px] cursor-pointer;
}
</style>
